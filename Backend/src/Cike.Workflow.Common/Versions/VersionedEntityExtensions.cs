namespace Cike.Workflow.Common.Extensions;

/// <summary>
/// Provides extension methods for <see cref="IVersion"/> objects.
/// </summary>
public static class IVersionExtensions
{
    ...
    public static bool WithVersion(this IVersion entity, VersionOptions versionOptions)
    {
    ...
    public static IEnumerable<T> WithVersion<T>(
        ...
        VersionOptions versionOptions) where T : IVersion =>
    ...
    public static IQueryable<T> WithVersion<T>(this IQueryable<T> query, VersionOptions versionOptions) where T : IVersion
    {
        if (versionOptions.IsDraft)
    ...
    public static Expression<Func<T, bool>> WithVersion<T>(this Expression<Func<T, bool>> expression, VersionOptions versionOptions) where T : IVersion
    {
        if (versionOptions.IsDraft)
