...
public static class ExpressionExecutionContextExtensions
{
    ...
    /// Creates a dictionary for the specified <see cref="WorkflowExecutionContext"/> and <see cref="ActivityExecutionContext"/>.
    /// </summary>
    public static IDictionary<object, object> CreateTriggerIndexingPropertiesFrom(WorkflowActivity workflow, IDictionary<string, object> input) =>
        new Dictionary<object, object>
        {
    ...
    extension(ExpressionExecutionContext context)
    {
        ...
        /// </summary>
        public Variable CreateVariable<T>(string name, T? value, string? storageDriverType = null, Action<MemoryBlock>? configure = null)
        {
            ...
            {
                StorageDriverType = storageDriverType ?? nameof(WorkflowInstanceStorageDriver)
            };
    ...
    extension(ExpressionExecutionContext context)
    {
        ...
        public bool IsContainedWithinCompositeActivity()
        {
            ...
            var firstWorkflowContext = activityExecutionContext.GetAncestors().FirstOrDefault(x => x.Activity is WorkflowActivity);
        ...
        /// </summary>
        public IEnumerable<(string Name, object? Value)> GetWorkflowInputs()
        {
