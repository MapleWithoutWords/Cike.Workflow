...
internal class ActivityRegistryLookupService(IActivityRegistry activityRegistry, IEnumerable<IActivityProvider> providers) : IActivityRegistryLookupService, IScopedDependency
{
    /// <inheritdoc />
