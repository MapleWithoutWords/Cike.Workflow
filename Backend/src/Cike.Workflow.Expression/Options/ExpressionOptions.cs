...
namespace Cike.Workflow.Expressions.Options;
...
public class ExpressionOptions
{
    ...
    public void AddTypeAlias<T>() => RegisterTypeAlias(typeof(T), typeof(T).Name);

    public void AddTypeAlias<T>(string alias) => RegisterTypeAlias(typeof(T), alias);
}
